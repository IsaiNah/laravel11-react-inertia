...
export default function Create({ auth, projects, users }) {
    ...
    return (
        ...
        >
            ...
            <Head title="Tasks" />
            {/* !!! viewing the incoming data using JSON.stringify, can be used everywhere to view incoming data  !!!*/}
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    shadow sm:rounded-lg">
                            ...
                            <div className="mt-4">
                                ...
                                <InputError message={errors.task_due_date}
                                    className="mt-2"
                                />
                            </div>
                            {/* select input */}
                            ...
                            <div className="mt-4 text-right">
                                <Link href={route("task.index")} className="bg-gray-100 py-1 px-3
